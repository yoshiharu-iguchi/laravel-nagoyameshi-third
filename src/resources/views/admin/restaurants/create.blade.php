                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="lowest_price" name="lowest_price">
                                ...
                                @for ($i = 0; $i < 20; $i++)
                                    @php $lowest_price = 500 + (500 * $i); @endphp
                                    <option value="{{ $lowest_price }}" @selected($lowest_price == old('lowest_price'))>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="highest_price" name="highest_price">
                                <option value="" hidden>選択してください</option>
                                @for ($i = 0; $i < 20; $i++)
                                    @php $highest_price = 500 + (500 * $i); @endphp
                                    <option value="{{ $highest_price }}" @selected($highest_price == old('highest_price'))>
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="opening_time" name="opening_time">
                                ...
                                @for ($i = 0; $i < 48; $i++)
                                    ...
                                    <option value="{{ $opening_time }}" @selected($opening_time == old('opening_time'))>{{ $opening_time }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="closing_time" name="closing_time">
                                ...
                                @for ($i = 0; $i < 48; $i++)
                                    ...
                                    <option value="{{ $closing_time }}" @selected($closing_time == old('closing_time'))>{{ $closing_time }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="col-md-7">
                                <select class="form-control form-select" id="category{{ $i + 1 }}" name="category_ids[]">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" @selected(old("category_ids.{$i}") == $category->id)>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
