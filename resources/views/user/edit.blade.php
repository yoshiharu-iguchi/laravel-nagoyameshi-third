            ...
            <div class="col-xl-5 col-lg-6 col-md-8">
                ...
                <form method="POST" action="{{ route('user.update', $user) }}">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="birthday" name="birthday" value="{{ old('birthday', $user->birthday ? date('Ymd', strtotime($user->birthday)) : '') }}" pattern="[0-9]{8}" title="誕生日は8桁の半角数字で入力してください。" maxlength="8" autocomplete="bday" placeholder="19950401">
                        </div>
                    </div>
